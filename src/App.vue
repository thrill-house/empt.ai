      ...
      <header>
        ...
        <div class="tweakers">
          ...
          <select v-model="socketFieldTweaker">
            <option disabled value="">Choose</option>
            <option v-for="(socketField, index) in sockets.list" :value="index" :key="socketField.name">
              {{ socketField.name }}
            </option>
          </select>
        </div>
      ...
      <header>
        ...
        <div class="tweakers">
          ...
          <select v-model="socketSlotTweaker">
            <option disabled value="">Choose</option>
            <option v-for="socketSlot in slots" :value="socketSlot" :key="socketSlot.name">
              {{ socketSlot.name }}
            </option>
          </select>
        </div>
      ...
      <header>
        ...
        <div class="tweakers">
          ...
          <select v-model="abilityAvailableTweaker">
            <option disabled value="">Choose</option>
            <option v-for="(ability, index) in abilities" :value="index" :key="ability.name">
              {{ ability.name }}
            </option>
          </select>
        </div>
